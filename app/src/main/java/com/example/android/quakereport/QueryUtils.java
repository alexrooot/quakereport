...
public class QueryUtils {
    ...
    public static ArrayList<EarthquakeConstructor> extractEarthquakes() {
        ...
        // must use a try loop
        try {
            // make the jsonobject readable for java, so make an object for json
            JSONObject baseJsonResponse = new JSONObject(SAMPLE_JSON_RESPONSE);
            //use the json object to subdivid more the json file into object/array/...
            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("features");

            //loop or get individual elements
            ...
            //must use catch to prevent system crash
